...
export default function Explore() {
    ...
    const [shortOpt, setshortOpt] = useState('')

    const handleShortOpt = (value)=>{
      setshortOpt(value)
      // console.log({shortOpt: shortOpt})
    }

  return (
    <div>
        
        {/* <FilterBar products={ product } /> */}
        ...
        <div className=" w-screen mt-[1px] px-6 sm:px-10 py-2 sm:py-4 flex items-center justify-between bg-gray-200 ">
            ...
            <div className="flex items-center gap-4">
                ...
                <div className="">
                    <p className='text-md text-black font-poppins hidden md:inline ' >{`Showing ${product.length} - ${product.length} results out of ${product.length}`}</p>
                </div>
            ...
            <div className=" flex items-center gap-4">
              ...
              <ShortOption sendShortOpt={ handleShortOpt } />
            </div>
        ...
        <section className='my-3 lg:my-10 px-2 md:px-5 lg:px-24 ' >
            <div className=" flex items-center gap-3 ">
                ...
                <h1 className=' text-red-600 font-poppins text-lg font-semibold' >Products</h1>
            </div>

            <div className=" flex items-center justify-between">
                <h1 className=' text-xl sm:text-2xl font-poppins font-semibold' >Explore All Products</h1>
            ...
            <div  className=" py-3 lg:py-5  w-full  ">
                ...
                <div className=" h-full  grid place-items-center place-content-center grid-cols-[auto_auto]  md:grid-cols-[auto_auto_auto]  lg:grid-cols-[auto_auto_auto_auto] gap-5 ">
                    ...
                    {
                        // [...product].sort( () => 0.5 - Math.random() ).slice(0, 25).map((e)=>{
                        [...product].sort( shortOpt.fun ).slice(0, 25).map((e)=>{
                            return (
...
const ShortOption = ({ sendShortOpt })=>{
    
    const options = [
        { id: 1, name : 'Default', fun: () => 0.5 - Math.random() },
        { id: 2, name : 'Recency', fun: () => 0.5 - Math.random() },
        { id: 3, name : 'Low - High', fun: (a, b) => a.price - b.price },
        { id: 4, name : 'High - Low', fun: (a, b) => b.price - a.price },
        { id: 5, name : 'Popular', fun: (a, b) => b.rating - a.rating  },
      ];
    const [selected, setSelected] = useState(options[0]);

    useEffect(() => {
      // console.log(selected)
      sendShortOpt(selected)
